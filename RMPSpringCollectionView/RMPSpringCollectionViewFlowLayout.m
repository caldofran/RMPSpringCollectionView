...
//  Thanks for this: http://www.objc.io/issue-5/collection-views-and-uidynamics.html
//
...
static const CGFloat kBouncyness = 1500;
...
- (void)prepareLayout
{
    ...
    [newlyVisibleItems enumerateObjectsUsingBlock:^(UICollectionViewLayoutAttributes *item, NSUInteger idx, BOOL *stop) {
        ...
        if (!CGPointEqualToPoint(CGPointZero, touchLocation)) {
            ...
            CGFloat scrollResistance = (yDistanceFromTouch + xDistanceFromTouch) / kBouncyness;
